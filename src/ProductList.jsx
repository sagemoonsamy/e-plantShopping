...
function ProductList({ onHomeClick }) {
    ...
    const plantsArray = [
        /* ... (Your plantsArray data remains the same) ... */
        {
            ...
            plants: [
                ...
                // ... (Include all other plants from your original array here)
            ]
        },
                        ...
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                <div style={{ position: 'relative' }}>
                                    ...
                                    <span className="cart-quantity-count" style={{ position: 'absolute', top: '10px', right: '10px', backgroundColor: 'red', borderRadius: '50%', padding: '2px 8px', fontSize: '16px' }}>
